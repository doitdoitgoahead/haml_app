...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { College: @register.College, Faculty: @register.Faculty, Name: @register.Name, Team: @register.Team, UserName: @register.UserName, Zeminar: @register.Zeminar }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { College: @register.College, Faculty: @register.Faculty, Name: @register.Name, Team: @register.Team, UserName: @register.UserName, Zeminar: @register.Zeminar }
    assert_redirected_to register_path(assigns(:register))
  end
